...
See an example project submission [here](https://github.com/ICP-Hacker-House/ICP_Hacker_House_Devcon_BKK/issues/2).
...
To submit a challenge for the hackathon - open an [Issue]([https://github.com/ICP-Hacker-House/Devcon_BKK/issues/new](https://github.com/ICP-Hacker-House/Devcon_BKK/issues/new)) on this repository before the deadline.
